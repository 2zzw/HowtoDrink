<template>
  <div class="drinks-page">
    <div class="page-header">
      <div class="container">
        <h1 class="page-title">🍷 酒品系列</h1>
        <p class="page-subtitle">从经典鸡尾酒到创意调酒，享受微醺时光</p>
      </div>
    </div>
    ...
    <div class="container">
      <div class="filters-section">
        ...
        <div class="results-info">找到 {{ filteredAlcoholDrinks.length }} 种酒品配方</div>
      </div>

      <div class="drinks-grid">
        <DrinkCard
          v-for="drink in filteredAlcoholDrinks"
          :key="drink.id"
          :drink="drink"
          class="animate__animated animate__fadeInUp"
          :style="{ animationDelay: `${filteredAlcoholDrinks.indexOf(drink) * 0.1}s` }"
        />
      </div>

      <div v-if="filteredAlcoholDrinks.length === 0" class="no-results">
...
const alcoholDrinks = computed(() => drinkStore.drinksByType('alcohol'))

const filteredAlcoholDrinks = computed(() => {
  let result = [...alcoholDrinks.value]
